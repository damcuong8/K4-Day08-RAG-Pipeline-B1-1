...
PLANNER_THINKING_TOKEN_BUDGET = _positive_int_env("PLANNER_THINKING_TOKEN_BUDGET", 2048)
...
ENABLE_ANSWER_CHECKER_NODE = _bool_env("ENABLE_ANSWER_CHECKER_NODE", True)

COMPRESS_LLM_ENABLE_THINKING = _bool_env("COMPRESS_LLM_ENABLE_THINKING", False)
...
COMPRESS_TARGET_MAX_WORKERS = _positive_int_env("COMPRESS_TARGET_MAX_WORKERS", 8)
